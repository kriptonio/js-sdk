...
export const GenericParameterAttributes = {
  ...
  ReferenceTypeConstraint:
    'ReferenceTypeConstraint' as GenericParameterAttributes,
  NotNullableValueTypeConstraint:
    'NotNullableValueTypeConstraint' as GenericParameterAttributes,
  DefaultConstructorConstraint:
    'DefaultConstructorConstraint' as GenericParameterAttributes,
